...
const items = [
  { id: 1, label: "Banana", data: "🍌" },
  { id: 2, label: "Apple", data: "🍎" },
  { id: 3, label: "Grape", data: "🍇" },
  { id: 4, label: "Mango", data: "🥭" },
  { id: 5, label: "Peach", data: "🍑" },
];
...
export default function DropDown() {
  ...
  return (
    <div className="flex flex-col max-w-2xl">
      <div className="self-end relative">
        ...
        >
          <span className="flex-1">
            {selectedItem ? selectedItem.label : "MENU"}
          </span>
      ...
      {selectedId && (
        <div className="self-center p-10 mt-10 text-6xl">
          {selectedItem?.data}
        </div>
      )}
    </div>
